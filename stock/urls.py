...
urlpatterns = [
    ...
    # 2b: edit / upload / confirm flows behind the same preview namespace.
    path("recipes-ds-preview/upload/", views.recipe_upload_ds_preview,
         name="recipe_upload_ds_preview"),
    path("recipes-ds-preview/upload/preview/", views.recipe_upload_preview_ds_preview,
         name="recipe_upload_preview_ds_preview"),
    path("recipes-ds-preview/bulk-archive/", views.recipe_bulk_archive_ds_preview,
         name="recipe_bulk_archive_ds_preview"),
    path("recipes-ds-preview/bulk-restore/", views.recipe_bulk_restore_ds_preview,
         name="recipe_bulk_restore_ds_preview"),
    path("recipes-ds-preview/bulk-delete/", views.recipe_bulk_delete_ds_preview,
         name="recipe_bulk_delete_ds_preview"),
    path("recipes-ds-preview/<int:pk>/", views.recipe_detail_ds_preview, name="recipe_detail_ds_preview"),
    path("recipes-ds-preview/<int:pk>/edit/", views.recipe_edit_ds_preview,
         name="recipe_edit_ds_preview"),
    path("recipes-ds-preview/<int:pk>/delete/", views.recipe_delete_ds_preview,
         name="recipe_delete_ds_preview"),
